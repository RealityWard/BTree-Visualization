...
namespace ThreadTesting
{
  ...
  public partial class ThreadTests(int degree)
  {
    ...
    private void DefineStatusPrecedence()
    {
      ...
      _AcceptStates = [0, 71, 3, 7, 14, 17, 18, 19, 21, 31, 34, 35, 38, 39, 41, 70, 57, 62, 60, 64, 68, 66, 67];
      ...
      _StatusPrecedence[34].Add(NodeStatus.FoundRange, 35);
      _StatusPrecedence[35].Add(NodeStatus.SSearching, 33);
      _StatusPrecedence[36].Add(NodeStatus.DSearching, 37);
      _StatusPrecedence[37].Add(NodeStatus.DSearching, 37);
      _StatusPrecedence[37].Add(NodeStatus.DeletedRange, 38);
      _StatusPrecedence[38].Add(NodeStatus.UnderFlow, 39);
      _StatusPrecedence[38].Add(NodeStatus.NodeDeleted, 40);
      _StatusPrecedence[38].Add(NodeStatus.Merge, 40);
      _StatusPrecedence[40].Add(NodeStatus.MergeParent, 41);
      _StatusPrecedence[41].Add(NodeStatus.Merge, 40);
      _StatusPrecedence[41].Add(NodeStatus.UnderFlow, 42);
      _StatusPrecedence[42].Add(NodeStatus.Shift, 39);
      _StatusPrecedence[43].Add(NodeStatus.DSearching, 44);
      _StatusPrecedence[44].Add(NodeStatus.DSearching, 44);
      _StatusPrecedence[44].Add(NodeStatus.DeletedRange, 45);
      _StatusPrecedence[45].Add(NodeStatus.UnderFlow, 46);
      _StatusPrecedence[45].Add(NodeStatus.NodeDeleted, 47);
      _StatusPrecedence[45].Add(NodeStatus.Merge, 47);
      _StatusPrecedence[47].Add(NodeStatus.MergeParent, 48);
      _StatusPrecedence[48].Add(NodeStatus.Merge, 47);
      _StatusPrecedence[48].Add(NodeStatus.UnderFlow, 49);
      _StatusPrecedence[49].Add(NodeStatus.Shift, 46);
      _StatusPrecedence[45].Add(NodeStatus.DSearching, 50);
      _StatusPrecedence[46].Add(NodeStatus.DSearching, 50);
      _StatusPrecedence[48].Add(NodeStatus.DSearching, 50);
      _StatusPrecedence[50].Add(NodeStatus.DSearching, 50);
      _StatusPrecedence[50].Add(NodeStatus.DeletedRange, 51);
      _StatusPrecedence[51].Add(NodeStatus.UnderFlow, 52);
      _StatusPrecedence[51].Add(NodeStatus.NodeDeleted, 53);
      _StatusPrecedence[51].Add(NodeStatus.Merge, 53);
      _StatusPrecedence[53].Add(NodeStatus.MergeParent, 54);
      _StatusPrecedence[54].Add(NodeStatus.Merge, 53);
      _StatusPrecedence[54].Add(NodeStatus.UnderFlow, 55);
      _StatusPrecedence[55].Add(NodeStatus.Shift, 52);
      _StatusPrecedence[51].Add(NodeStatus.Rebalanced, 56);
      _StatusPrecedence[51].Add(NodeStatus.DeletedRange, 70);
      _StatusPrecedence[52].Add(NodeStatus.Rebalanced, 56);
      _StatusPrecedence[52].Add(NodeStatus.NodeDeleted, 56);
      _StatusPrecedence[52].Add(NodeStatus.DeletedRange, 70);
      _StatusPrecedence[54].Add(NodeStatus.Rebalanced, 56);
      _StatusPrecedence[54].Add(NodeStatus.NodeDeleted, 56);
      _StatusPrecedence[54].Add(NodeStatus.DeletedRange, 70);
      _StatusPrecedence[56].Add(NodeStatus.UnderFlow, 57);
      _StatusPrecedence[56].Add(NodeStatus.NodeDeleted, 58);
      _StatusPrecedence[56].Add(NodeStatus.Merge, 59);
      _StatusPrecedence[57].Add(NodeStatus.UnderFlow, 62);
      _StatusPrecedence[57].Add(NodeStatus.Merge, 63);
      _StatusPrecedence[57].Add(NodeStatus.NodeDeleted, 63);
      _StatusPrecedence[57].Add(NodeStatus.DeletedRange, 70);
      _StatusPrecedence[58].Add(NodeStatus.NodeDeleted, 58);
      _StatusPrecedence[58].Add(NodeStatus.MergeParent, 60);
      _StatusPrecedence[59].Add(NodeStatus.MergeParent, 60);
      _StatusPrecedence[60].Add(NodeStatus.NodeDeleted, 63);
      _StatusPrecedence[60].Add(NodeStatus.UnderFlow, 64);
      _StatusPrecedence[60].Add(NodeStatus.Merge, 65);
      _StatusPrecedence[60].Add(NodeStatus.DeletedRange, 70);
      _StatusPrecedence[62].Add(NodeStatus.DeletedRange, 70);
      _StatusPrecedence[63].Add(NodeStatus.MergeParent, 68);
      _StatusPrecedence[64].Add(NodeStatus.Shift, 57);
      _StatusPrecedence[64].Add(NodeStatus.DeletedRange, 70);
      _StatusPrecedence[65].Add(NodeStatus.MergeParent, 66);
      _StatusPrecedence[66].Add(NodeStatus.Merge, 65);
      _StatusPrecedence[66].Add(NodeStatus.UnderFlow, 67);
      _StatusPrecedence[66].Add(NodeStatus.DeletedRange, 70);
      _StatusPrecedence[67].Add(NodeStatus.Shift, 57);
      _StatusPrecedence[67].Add(NodeStatus.DeletedRange, 70);
      _StatusPrecedence[68].Add(NodeStatus.Merge, 63);
      _StatusPrecedence[68].Add(NodeStatus.UnderFlow, 69);
      _StatusPrecedence[68].Add(NodeStatus.DeletedRange, 70);
      _StatusPrecedence[69].Add(NodeStatus.Shift, 62);
      _StatusPrecedence[70].Add(NodeStatus.DeletedRange, 51);
    }
